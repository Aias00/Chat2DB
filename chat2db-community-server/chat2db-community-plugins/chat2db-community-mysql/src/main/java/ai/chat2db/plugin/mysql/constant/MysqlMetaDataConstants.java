...
public final class MysqlMetaDataConstants {
    ...
    public static final String SQL_SIZE_QUOTE = "`";
    ...
    public static final String SQL_SHOW_PROCESSLIST = "SELECT ID, USER, HOST, DB, COMMAND, TIME, STATE, INFO FROM information_schema.processlist ORDER BY ID";
    public static final String SQL_KILL = "KILL";
    public static final String SQL_KILL_QUERY_SUFFIX = " QUERY";
    public static final String SQL_SHOW_INNODB_STATUS = "SHOW ENGINE INNODB STATUS";

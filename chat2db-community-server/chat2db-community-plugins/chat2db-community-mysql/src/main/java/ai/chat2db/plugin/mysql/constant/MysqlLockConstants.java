...
public final class MysqlLockConstants {
    ...
    public static final String SOURCE_PERFORMANCE_SCHEMA = "performance_schema";
    public static final String SOURCE_INFORMATION_SCHEMA = "information_schema";
    ...
    public static final String MESSAGE_PRIVILEGE_REQUIRED =

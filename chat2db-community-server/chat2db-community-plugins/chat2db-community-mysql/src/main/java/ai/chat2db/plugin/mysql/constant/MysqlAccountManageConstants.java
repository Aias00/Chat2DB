...
public final class MysqlAccountManageConstants {
    ...
    public static final String SQL_SELECT_ROLE_ACCOUNTS = "SELECT DISTINCT FROM_USER AS role_user, FROM_HOST AS role_host FROM mysql.role_edges ORDER BY FROM_USER, FROM_HOST";

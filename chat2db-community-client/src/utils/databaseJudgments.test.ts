...
import {
  ...
  shouldShowMysqlForeignKeyEditor,
...
assert.equal(shouldShowMysqlForeignKeyEditor(DatabaseTypeCode.MYSQL), true);
assert.equal(shouldShowMysqlForeignKeyEditor(DatabaseTypeCode.POSTGRESQL), false);
